...
double Geom24::HMC_rand_nosplit(const int& Nt_min, const int& Nt_max, const double& dt_min, const double& dt_max, const int& iter, const int& gap, const int& adj, gsl_rng* engine, ostream& out_s, ostream& out_hl)
{
...
double Geom24::HMC_rand_nosplit(const int& Nt_min, const int& Nt_max, const double& dt_min, const double& dt_max, const int& iter, const int& gap, const int& adj, gsl_rng* engine, ostream& out_s)
{
    // initial (_i) and final (_f) potential2, potential4, kinetic, hamiltonian 
    double* en_i = new double [4];
    double* en_f = new double [4];
...
double Geom24::HMC_rand_nosplit(const int& Nt_min, const int& Nt_max, const double& dt_min, const double& dt_max, const int& iter, const int& adj, gsl_rng* engine)
{
    // initial (_i) and final (_f) potential2, potential4, kinetic, hamiltonian 
    double* en_i = new double [4];
    double* en_f = new double [4];
