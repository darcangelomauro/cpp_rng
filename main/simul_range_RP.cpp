...
int main(int argc, char** argv)
{
    ...
    while(in_dt >> g2)
    {
        ...
        G.HMC(sm.L, sm.dt, 100, engine, 0.65);
        double dt_min, dt_max;
        in_dt >> dt_min >> dt_max;
        G.HMC_RP(sm.L-50, sm.L+50, dt_min, dt_max, sm.iter_therm, engine);
        ...
        double ar = G.HMC_RP(sm.L-50, sm.L+50, dt_min, dt_max, sm.iter_simul, sm.gap, engine, out_s, out_hl);
