...
int main(int argc, char** argv)
{
    ...
    while(g2 < sm.g2_f)
    {
        ...
        // Find dt_min and dt_max
        G.HMC(sm.L, sm.dt, 1000, engine, 0.9);
        double dt_min = sm.dt;
        G.HMC(sm.L, sm.dt, 1000, engine, 0.4);
        double dt_max = sm.dt;
